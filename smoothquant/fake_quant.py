...
class NoisyW8A8Linear(W8A8Linear):
    ...
    def inject_error(self,y, w_scales, a_scales, err_prob):
        ...
        result_injected=result_injected.to(torch.float32)*w_scales*a_scales
...
# tt=torch.nn.Linear(108,128,bias=True)
# given_weight=torch.randn(2,108,128)
# given_activation=torch.randn(2,128,108)
# given_bias=torch.randn(108)
# # tt.weight.data=given_weight
# # tt.bias.data=given_bias
# data_in=torch.randn(128,128)
# err_prob=1e-2
